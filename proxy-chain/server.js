...
const parseHostHeader = require ( './tools' ).parseHostHeader;
const parseProxyAuthorizationHeader = require ( './tools' ).parseProxyAuthorizationHeader;
const parseUrl = require ('./tools' ).parseUrl;
const redactParsedUrl = require ('./tools' ).redactParsedUrl;
const HandlerForward = require ( './handler_forward' );
...
module.exports = { RequestError , Server }
