...
const isHopByHopHeader = require('./tools').isHopByHopHeader;
const isInvalidHeader = require('./tools').isInvalidHeader;
const addHeader = require('./tools').addHeader;
const maybeAddProxyAuthorizationHeader = require('./tools').maybeAddProxyAuthorizationHeader;
...
class HandlerForward extends HandlerBase {
    constructor(options) {
        super(options);
