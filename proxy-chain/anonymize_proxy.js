...
const PORT_SELECTION_CONFIG = require ('./tools').PORT_SELECTION_CONFIG;
...
function anonymizeProxy (proxyUrl, callback) {
...
function closeAnonymizedProxy  (anonymizedProxyUrl, closeConnections, callback)  {
...
module.exports = { anonymizeProxy , closeAnonymizedProxy };
